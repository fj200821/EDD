package com.android.jackapp.jusbcam.widget;
/*
 * UVCCamera
...
import com.android.jackapp.jusbcam.SurfaceViewStatusInterface;
...
public class UVCCameraTextureView extends TextureView	// API >= 14
	...
	private SurfaceViewStatusInterface listener;
...
//		mRenderHandler = RenderHandler.createHandler(surface);
		mHasSurface = true;
		listener.surfStatusCb(mHasSurface);
	}
	...
	public void setListener(
			SurfaceViewStatusInterface surfaceViewStatusInterface) {
		listener = surfaceViewStatusInterface;
	}
